...
export const experience: Experience[] = [
  ...
  },
  {
    ...
    description:
      "Building Bangladesh's first digital player and playing-ground matchmaking platform.",
    bullets: [
      "Shipping core platform features for PlayerLagbe — Bangladesh's 1st digital sports matchmaking SaaS.",
      'Collaborating with cross-functional teams to deliver scalable, production-grade applications.',
      'Operating with modern frameworks and best practices to keep the codebase maintainable as it grows.',
    ],
